...
public class HttpClientToHttpServer01 {
    ...
    public static String postAsJSON(String url, String json, Map<String, String> headers) throws IOException {
        ...
        CloseableHttpResponse response01 = null;
        try {
            response01 = httpclient.execute(httpPost);
            System.out.println(response01.getStatusLine());
            HttpEntity entity1 = response01.getEntity();
            return EntityUtils.toString(entity1, "UTF-8");
        } finally {
            if (null != response01) {
                response01.close();
    ...
    public static void main(String[] args) throws Exception {
        ...
        String text = HttpClientToHttpServer01.getAsString(url);
